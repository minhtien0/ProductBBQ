        ...
        <div class="px-5 py-3">
            ...
            <div class="flex justify-between mb-4">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('admin.product.food_combo.addForm') }}">
                    ...
                    <button onclick="openPopupDelete('Bạn muốn muốn xóa combo này?')"
            ...
            <!-- Table -->
             <form id="deleteForm" action="{{ route('admin.product.combo.delete') }}" method="POST" class="mb-4">
                @csrf
                @method('DELETE')
                    ...
                    <thead class="bg-gray-500 text-white">
                        <tr>
                           <th class="w-12 py-1 px-2 text-left">
                            ...
                            <th class="py-1 px-2 text-left text-sm">Avatar</th>
                        ...
                        @foreach ($combos as $combo)
                            <tr class="bg-gray-50">
                                <td class="py-3 px-2 border-t border-gray-200">
                                    <input name="ids[]" value="{{ $combo->id }}" type="checkbox"
                                ...
                                <td class="py-3 px-4 border-t border-gray-200">
                                    <div class="w-10 h-10 rounded-full overflow-hidden bg-gray-300">
                                        ...
                                        <img src="{{ asset('img/combo/' . $combo->image) }}" alt=""
                                ...
                                <td class="py-1 px-2 border-t border-gray-200 text-gray-700"><a href="{{ route('admin.food_combo.edit',$combo->id) }}">{{ $combo->codecombo }}</a></td>
