            ...
            <table class="min-w-full bg-white border-collapse">
                <thead class="bg-gray-500 text-white">
                    <tr>
                        ...
                        <th class="py-1 px-2 text-left text-sm">Lương Tháng</th>
                        <th class="py-1 px-2 text-left text-sm">Lương Cơ Bản</th>
                        <th class="py-1 px-2 text-left text-sm">Lương Tăng Ca</th>
                        <th class="py-1 px-2 text-left text-sm">Tổng Lương</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">3.567.000(đ)</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">789.000(đ)</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">4.321.000(đ)</td>
                    </tr>
                </tbody>
            </table>
        </div>
