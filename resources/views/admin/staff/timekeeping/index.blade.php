            ...
            <table class="min-w-full bg-white border-collapse">
                <thead class="bg-gray-500 text-white">
                    <tr>
                        ...
                        <th class="py-1 px-2 text-left text-sm">Tên Ca Làm</th>
                        <th class="py-1 px-2 text-left text-sm">Thời Gian Làm Việc</th>
                        <th class="py-1 px-2 text-left text-sm">Giờ Bắt Đầu</th>
                        <th class="py-1 px-2 text-left text-sm">Giờ Kết Thúc</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700"><a
                                href="{{ route('user.detail') }}">CA1</a></td>
