            ...
            <table class="min-w-full bg-white border-collapse">
                <thead class="bg-gray-500 text-white">
                    <tr>
                        ...
                        <th class="py-1 px-2 text-left text-sm">Số Tiền Tip</th>
                        <th class="py-1 px-2 text-left text-sm">Thời Gian Tip</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="py-1 px-2 border-t border-gray-200">
                            <span class="text-gray-600">120.000đ</span>
                        </td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">9:00 15/5/2025</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">ABCXYZ</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">15:00 15/5/2025</td>
                    </tr>
                </tbody>
            </table>
        </div>
