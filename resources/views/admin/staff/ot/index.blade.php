            ...
            <table class="min-w-full bg-white border-collapse">
                <thead class="bg-gray-500 text-white">
                    <tr>
                        ...
                        <th class="py-1 px-2 text-left text-sm">Thời Gian OT</th>
                        <th class="py-1 px-2 text-left text-sm">Số Giờ</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">3 (Tiếng)</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">Thiếu KPI</td>
