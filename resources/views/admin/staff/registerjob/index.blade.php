            ...
            <table class="min-w-full bg-white border-collapse">
                <thead class="bg-gray-500 text-white">
                    <tr>
                        ...
                        <th class="py-1 px-2 text-left text-sm">Ca Làm</th>
                        <th class="py-1 px-2 text-left text-sm">Thời Gian Làm Việc</th>
                        <th class="py-1 px-2 text-left text-sm">Thời Gian Đăng Kí</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">15/7/2025</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">15:00 10/7/2025</td>
                    </tr>
                </tbody>
            </table>
        </div>
