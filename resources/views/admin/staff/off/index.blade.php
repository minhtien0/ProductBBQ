            ...
            <table class="min-w-full bg-white border-collapse">
                <thead class="bg-gray-500 text-white">
                    <tr>
                        ...
                        <th class="py-1 px-2 text-left text-sm">Thời Gian Nghỉ</th>
                        <th class="py-1 px-2 text-left text-sm">Loại</th>
                        <th class="py-1 px-2 text-left text-sm">Lí Do</th>
                        <th class="py-1 px-2 text-left text-sm">Ghi Chú</th>
                        <th class="py-1 px-2 text-left text-sm">Trạng Thái</th>
                        <th class="py-1 px-2 text-left text-sm">Thời Gian Gửi</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700"><a
                                href="{{ route('user.detail') }}">Minh Tiến</a></td>
                        <td class="py-1 px-2 border-t border-gray-200">
                            <span class="text-gray-600">9:00 15/5/2025</span>
                        </td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">Bệnh</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">Thiếu Ngủ</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">Làm bù vào tuần sau hoặc ngày mai</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">Đã Duyệt</td>
                        <td class="py-1 px-2 border-t border-gray-200 text-gray-700">9:00 14/5/2025</td>
                    </tr>
                </tbody>
            </table>
        </div>
