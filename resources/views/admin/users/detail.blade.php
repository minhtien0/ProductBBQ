...
@section('content')
    <div class="flex">
        <div class="flex-1 bg-white rounded-lg border border-gray-200 shadow-sm p-6 mt-3">
            <h1 class="text-xl font-bold text-gray-800 mb-6">Thêm sản phẩm mới</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <!-- SKU -->
                <div>
                    <label for="sku" class="block text-sm font-medium text-gray-700 mb-1">MÃ SKU</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <!-- Product Status -->
                <div>
                    <label for="status" class="block text-sm font-medium text-gray-700 mb-1">TRẠNG THÁI SẢN PHẨM</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <!-- Category -->
                <div>
                    <label for="category" class="block text-sm font-medium text-gray-700 mb-1">DANH MỤC SẢN PHẨM</label>
                ...
                <!-- Product Type -->
                <div>
                    <label for="productType" class="block text-sm font-medium text-gray-700 mb-1">THẺ SẢN PHẨM</label>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4 mt-3">
            <div class="flex flex-col space-y-2">
                <button type="submit" class="w-full px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all duration-200 flex items-center justify-center">
                    <i class="fa-solid fa-plus mr-1"></i> Thêm sản phẩm
                </button>
                <button type="button" class="w-full px-3 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-all duration-200">
                    Hủy
                </button>
            </div>
        </div>
        ...
        <!-- Pricing -->
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
            <h3 class="text-sm font-medium text-gray-700 mb-3">THÔNG TIN GIÁ</h3>
        ...
        <!-- Product Visibility -->
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
            <h3 class="text-sm font-medium text-gray-700 mb-3">HIỂN THỊ</h3>
            <div class="space-y-2">
