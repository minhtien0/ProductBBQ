                    ...
                    <table class="min-w-full bg-white border-collapse">
                        <thead class="bg-gray-500 text-white">
                            <tr>
                                ...
                                <th class="py-1 px-2 text-left text-sm">Số lượng người</th>
                            ...
                            @foreach ($listTables as $table)
                                <tr class="bg-gray-50">
                                    ...
                                    <td class="py-1 px-2 border-t border-gray-200 text-gray-700"><a
                                            href="{{ route('admin.voucher.edit',['id' => $table->id]) }}">{{ $table->number }}</a></td>
                                    <td class="py-1 px-2 border-t border-gray-200">
                                        <span class="text-gray-600">{{ $table->quantity }} người</span>
                                    </td>
                                    <td class="py-1 px-2 border-t border-gray-200 text-gray-700">{{ $table->status }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
