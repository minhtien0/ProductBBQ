                    ...
                    <tbody>
                        ...
                        <tr class="bg-gray-50">
                            ...
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700"><a
                                    href="{{ route('user.detail') }}">VC001</a></td>
                            <td class="py-1 px-2 border-t border-gray-200">
                                <span class="text-gray-600">99.000(đ)</span>
                            </td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">12:00 15/5/2025</td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">12:00 15/6/2025</td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">25</td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">Còn</td>
