                ...
                <table class="min-w-full bg-white border-collapse">
                    <thead class="bg-gray-500 text-white">
                        <tr>
                            ...
                            <th class="py-1 px-2 text-left text-sm">Tên Người Đặt</th>
                            <th class="py-1 px-2 text-left text-sm">Số Điện Thoại</th>
                            <th class="py-1 px-2 text-left text-sm">Số Người</th>
                            <th class="py-1 px-2 text-left text-sm">Thời Gian</th>
                            <th class="py-1 px-2 text-left text-sm">Bàn</th>
                            <th class="py-1 px-2 text-left text-sm">Thời Gian Đặt</th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-gray-50">
                            ...
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700"><a
                                    href="{{ route('user.detail') }}">Nguyễn Minh Tiến</a></td>
                            <td class="py-1 px-2 border-t border-gray-200">
                                <span class="text-gray-600">123456789</span>
                            </td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">2</td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">18:30 15/5/2025</td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">-</td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">18:30 14/5/2025</td>
                            <td class="py-1 px-2 border-t border-gray-200 text-gray-700">Chờ Xác Nhận</td>
                        </tr>
                    </tbody>
                </table>
            </div>
