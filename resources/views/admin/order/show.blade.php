        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border">
                    ...
                    <div class="px-6 py-4">
                        <form action="{{ route('admin.order.updateStatusBringBack', $order->id_order) }}" method="POST"
                            class="space-y-4">
                            @csrf
                            <div>
                                ...
                                <select name="statusorder"
                                    ...
                                    @foreach(['Chờ Xác Nhận', 'Đang Thực Hiện', 'Đang Giao Hàng', 'Hoàn Thành', 'Đã Hủy'] as $st)
                                        <option value="{{ $st }}" @if($order->statusorder == $st) selected @endif>{{ $st }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <button type="submit"
                                class="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-2 px-4 rounded-md transition duration-200 flex items-center justify-center">
