                ...
                <div class="relative inline-block">
                    ...
                    <button id="languageToggle" class="focus:outline-none">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/2/21/Flag_of_Vietnam.svg"
                            alt="Tiếng Việt" class="w-8 h-6 cursor-pointer">
                    </button>
    ...
    <div class="flex">
        ...
        <div class="w-72 bg-white rounded-md border border-gray-200 shadow-sm">
            <div class="flex flex-col p-4 space-y-2">
                ...
                <div class="space-y-1">
                    <!-- Dashboard -->
                    <div class="py-2 px-3 rounded-md text-gray-700 cursor-pointer  hover:bg-gray-300 hover:bg-gradient-to-r hover:from-gray-300 hover:to-gray-50 hover:scale-105 hover:shadow-sm transition-all duration-200"
                    >
