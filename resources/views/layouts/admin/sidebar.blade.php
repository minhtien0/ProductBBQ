    ...
    <div class="flex flex-col p-4 space-y-2">
        ...
        <div class="space-y-1">
            @if (session('staff_role') === 'Quản Lí')
                ...
                <div
                    ...
                    <div class="flex items-center space-x-2">
                        <a href="{{ route('admin.cashier') }}">
                            ...
                            <span class="text-sm">Doanh Thu</span>
                        </a>
                    </div>
                </div>
                ...
                <!-- Nhân Viên -->
                <div
                    class="py-2 px-3 rounded-md text-gray-700 cursor-pointer  hover:bg-gray-300 hover:bg-gradient-to-r hover:from-gray-100 hover:to-gray-50 hover:scale-105 hover:shadow-sm transition-all duration-200">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                ...
                <div id="productDropdown"
                    ...
                    <div class="py-1.5 px-2 rounded-md text-gray-700 cursor-pointer hover:bg-gray-300 hover:text-teal-500 hover:scale-105 transition-all duration-200  animate-fade-in"
