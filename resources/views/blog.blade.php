  ...
  <div class="max-w-6xl mx-auto px-3 py-8">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-xl shadow hover:shadow-lg transition p-3 flex flex-col">
        ...
        <div class="flex items-center mt-3 mb-2 gap-2">
          <img src="img/mtien.jpg" alt="" class="w-7 h-7 rounded-full object-cover border-2 border-white shadow">
          <div>
        ...
        <p class="text-gray-500 text-sm line-clamp-2 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate sapiente deserunt accusantium...</p>
        <div class="flex justify-between items-center mt-auto text-xs">
          <a href="#" class="text-[#22223b] hover:text-[#e60012] font-medium">Read More <i class="fa fa-arrow-right text-[10px]"></i></a>
      ...
      <div class="bg-white rounded-xl shadow hover:shadow-lg transition p-3 flex flex-col">
        <div class="relative">
          ...
          <span class="absolute top-2 left-2 bg-[#e60012] text-white text-xs px-2 py-1 rounded">Restaurant</span>
        </div>
        <div class="flex items-center mt-3 mb-2 gap-2">
          <img src="img/hdong.jpg" alt="" class="w-7 h-7 rounded-full object-cover border-2 border-white shadow">
          <div>
        ...
        <p class="text-gray-500 text-sm line-clamp-2 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus commodo...</p>
        <div class="flex justify-between items-center mt-auto text-xs">
          <a href="#" class="text-[#22223b] hover:text-[#e60012] font-medium">Read More <i class="fa fa-arrow-right text-[10px]"></i></a>
          <div class="flex items-center gap-1 text-gray-400">
            <i class="fa-regular fa-comment-dots"></i>
      ...
      <div class="bg-white rounded-xl shadow hover:shadow-lg transition p-3 flex flex-col">
        ...
        <p class="text-gray-500 text-sm line-clamp-2 mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, nobis...</p>
        <div class="flex justify-between items-center mt-auto text-xs">
          <a href="#" class="text-[#22223b] hover:text-[#e60012] font-medium">Read More <i class="fa fa-arrow-right text-[10px]"></i></a>
          <div class="flex items-center gap-1 text-gray-400">
            <i class="fa-regular fa-comment-dots"></i>
    ...
    <div class="flex justify-center items-center mt-10">
      <nav class="flex gap-2">
        <button class="w-8 h-8 rounded-full border border-gray-300 text-gray-700 hover:bg-[#e60012] hover:text-white transition"><i class="fa fa-angle-left"></i></button>
        <button class="w-8 h-8 rounded-full border text-[#e60012] border-[#e60012] font-semibold hover:bg-[#e60012] hover:text-white transition">1</button>
        <button class="w-8 h-8 rounded-full border border-gray-300 text-gray-700 hover:bg-[#e60012] hover:text-white transition">2</button>
        <button class="w-8 h-8 rounded-full border border-gray-300 text-gray-700 hover:bg-[#e60012] hover:text-white transition">3</button>
        <button class="w-8 h-8 rounded-full border border-gray-300 text-gray-700 hover:bg-[#e60012] hover:text-white transition"><i class="fa fa-angle-right"></i></button>
      </nav>
    </div>
  </div>
</body>
