            ...
            <form method="POST" action="/login" class="space-y-4">
                ...
                <div class="relative">
                    <input type="password" name="password" placeholder="Password" required
                        class="w-full border border-[#4A4A4A] rounded p-2 bg-black text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF6F61]">
                    <svg class="h-5 w-5 text-[#4A4A4A] absolute right-2 top-1/2 transform -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex items-center justify-between text-sm">
                    <label class="flex items-center">
                        ...
                        <span class="text-[#4A4A4A]">Remember Me</span>
                    </label>
                    <a href="#" class="text-[#C71585] hover:underline">Forgot Password?</a>
                </div>

                <button type="submit" class="w-full bg-[#FF3D3D] text-white rounded p-2 hover:bg-[#FF6F61] transition duration-150">Login</button>
            </form>
            <p class="text-center mt-4 text-sm text-[#4A4A4A]">Don't have an account? <a href="#" class="text-[#C71585] hover:underline">Register</a></p>
        </div>
    </div>
</div>
</body>
